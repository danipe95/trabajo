...
public class Adaptadorproduct {private val dataSet: MutableList<ProductEntity>,private val listener:OnItemClickListener) :
    RecyclerView.Adapter<Adaptadorproduct.ViewHolder>() {
